...
var myApp = new Framework7({
    ...
    on: {
        pageInit: function (page) {
			...
			else if (page.route.name === "vibratie"){
				$$('#btnVibratie1').on('click', function() {
					vibrate(1);
				})
				$$('#btnVibratie2').on('click', function() {
					vibrate(2);
				})
				$$('#btnVibratie3').on('click', function() {
					vibrate(3);
				})
				$$('#btnVibratie4').on('click', function() {
					vibrate(4);
				})
...
function vibrate(mode) {
	let modes = [[1000,500,1000,500,1000],[500,1000,500,1000,500],[1000,1000,2000,2000,3000,3000],[5000,1000,4000,1000,3000,1000,2000]]
	console.log(modes[mode-1])
	navigator.vibrate(modes[mode-1])
}
